...
namespace Catch {
     ...
     * not report srtion expansion at all). Derived classes can use two
...
#endif // CATCH_AMALGAMATED_HPP_INCLUDEDuccessful assertions, or because the deriving reporter does not use asse
